...
mixin _$ApiResponse<T, U> {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(
            T? content, int? statusCode, Map<String, List<String>> headers)
        $default, {
    required TResult Function(String message, bool? isSocketException,
            U? content, int? statusCode)
        error,
  }) =>
...
abstract class _$$ApiResponseDataCopyWith<T, U, $Res>
  ...
  @override
  @useResult
  $Res call({T? content, int? statusCode, Map<String, List<String>> headers});
}
...
class _$ApiResponseData<T, U> implements ApiResponseData<T, U> {
  ...
  @override
  String toString() {
    return 'ApiResponse<$T, $U>(content: $content, statusCode: $statusCode, headers: $headers)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(content, statusCode, headers);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(content, statusCode, headers);
  }
...
class __$$ApiResponseErrorCopyWithImpl<T, U, $Res>
  ...
  $Res call({
    Object? message = null,
    Object? isSocketException = freezed,
    Object? content = freezed,
    Object? statusCode = freezed,
  }) {
    return _then(_$ApiResponseError<T, U>(
      message: null == message
          ...
          : message // ignore: cast_nullable_to_non_nullable
              as String,
      isSocketException: freezed == isSocketException
